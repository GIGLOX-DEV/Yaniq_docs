...
parent: Services
nav_order: 5
description: "Cart Service microservice documentation"
---
...
The **Cart Service** is a core microservice in the YaniQ e-commerce platform.
...
```bash
docker build -t yaniq/cart-service .
docker run -p "configserver:http://localhost:8888":"configserver:http://localhost:8888" yaniq/cart-service
```
