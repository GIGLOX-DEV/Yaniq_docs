...
parent: Services
nav_order: 8
description: "File Service microservice documentation"
---
...
The **File Service** is a core microservice in the YaniQ e-commerce platform.
...
```bash
docker build -t yaniq/file-service .
docker run -p 8080:8080 yaniq/file-service
```
