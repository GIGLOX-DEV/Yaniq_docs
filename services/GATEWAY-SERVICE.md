...
parent: Services
nav_order: 9
description: "Gateway Service microservice documentation"
---
...
The **Gateway Service** is a core microservice in the YaniQ e-commerce platform.
...
```bash
docker build -t yaniq/gateway-service .
docker run -p 8080:8080 yaniq/gateway-service
```
