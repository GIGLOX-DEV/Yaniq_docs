...
parent: Services
nav_order: 13
description: "Order Service microservice documentation"
---
...
The **Order Service** is a core microservice in the YaniQ e-commerce platform.
...
```bash
docker build -t yaniq/order-service .
docker run -p "configserver:http://localhost:8888":"configserver:http://localhost:8888" yaniq/order-service
```
