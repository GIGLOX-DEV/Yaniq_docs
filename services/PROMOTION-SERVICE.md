...
parent: Services
nav_order: 16
description: "Promotion Service microservice documentation"
---
...
The **Promotion Service** is a core microservice in the YaniQ e-commerce platform.
...
```bash
docker build -t yaniq/promotion-service .
docker run -p "configserver:http://localhost:8888":"configserver:http://localhost:8888" yaniq/promotion-service
```
