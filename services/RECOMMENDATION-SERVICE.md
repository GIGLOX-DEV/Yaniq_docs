...
parent: Services
nav_order: 17
description: "Recommendation Service microservice documentation"
---
...
The **Recommendation Service** is a core microservice in the YaniQ e-commerce platform.
...
```bash
docker build -t yaniq/recommendation-service .
docker run -p 8080:8080 yaniq/recommendation-service
```
