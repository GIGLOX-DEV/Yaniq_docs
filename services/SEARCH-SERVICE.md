...
parent: Services
nav_order: 19
description: "Search Service microservice documentation"
---
...
The **Search Service** is a core microservice in the YaniQ e-commerce platform.
...
```bash
docker build -t yaniq/search-service .
docker run -p 8080:8080 yaniq/search-service
```
