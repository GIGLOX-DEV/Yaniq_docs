...
parent: Services
nav_order: 21
description: "Support Service microservice documentation"
---
...
The **Support Service** is a core microservice in the YaniQ e-commerce platform.
...
```bash
docker build -t yaniq/support-service .
docker run -p 8080:8080 yaniq/support-service
```
